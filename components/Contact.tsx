...
export const Contact: React.FC = () => {
  return (
    <section id="empatia" className="py-24 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-8 leading-tight">
            Sabemos lo que te costó <br/>
          ...
          <div className="inline-flex flex-col items-center gap-6 p-10 bg-slate-50 rounded-3xl border border-slate-100 shadow-xl">
            ...
            >
              <svg className="w-8 h-8 fill-current group-hover:scale-110 transition" viewBox="0 0 24 24">
